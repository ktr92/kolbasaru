        ...
        $.post(
            ...
            function (result) {
                ...
                if (result.ENABLED_TEPLO) {
                    ...
                    $('[data-entity="teplo-checkbox"]').find('input').prop('disabled', false).attr('disabled', false);
                  ...
                  /*   $('[data-entity="teplo-checkbox"]').find('.disabled-text').show(); */
                    $('[data-entity="teplo-checkbox"]').find('input').prop('disabled', 'disabled').attr('disabled', 'disabled');
                }
                ...
                if (result.ENABLED_DOCS) {
                    ...
                    $('[data-entity="doc-checkbox"]').find('input').prop('disabled', false).attr('disabled', false);
                    $('[data-entity="doc-checkbox"]').find('.disabled-text').hide();
                } else {
                    $('[data-entity="doc-checkbox"]').addClass('disabled');
                    $('[data-entity="doc-checkbox"]').find('.disabled-text').hide();
                  /*   $('[data-entity="doc-checkbox"]').find('.disabled-text').show(); */
                    $('[data-entity="doc-checkbox"]').find('input').prop('disabled', 'disabled').attr('disabled', 'disabled');
                }
                ...
                if (result.TERMINALS) {
                    ...
                    $.each(result.TERMINALS, function (i, val) {
                        ...
                        let _html =
                            ...
                            this.FullAdress +
                            "</span>\n" +
                            '<span class="dropdownJS__text3">График работы: 10:00 - 19:00</span>\n'
