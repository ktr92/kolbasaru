...
function initMask() {
  ...
  $('[data-mask="passport_1"]').inputmask({
    showMaskOnHover: true,
    showMaskOnFocus: true,
    mask: "9999"
  })
  $('[data-mask="passport_2"]').inputmask({
    showMaskOnHover: true,
    showMaskOnFocus: true,
    mask: "999999"
  })
...
const switcher = () => {
  jQuery(".switcher a").on("click", function (e) {
    ...
    jQuery("#cityInput2").val(input1).trigger('change');
...
const fastBtn = () => {
  jQuery("[data-fast] a").on("click", function (e) {
    ...
    jQuery(`input[name=${target}]`).val(jQuery(this).text()).removeClass('error').trigger('change');
...
const customSelect = () => {
  jQuery(document).on('click', '.customselect [data-selectbutton]', function (e) {
    e.preventDefault()
    jQuery(this).closest('.customselect').find('.calcselect__list').toggleClass('active')
  ...
  jQuery(document).on('click', '.customselect li', function (e) {
    ...
    $wrapper.find('[data-selectbutton]').removeClass('active')

  })
}
const termSelect = () => {
  jQuery(document).on('click', '.calcselectblock:not(.disabled) [data-selectbutton]', function (e) {
    e.preventDefault()
    jQuery(this).closest('.calcselect').find('.calcselect__list').addClass('active')
  })
  jQuery(".calcselectblock .calcselect__list li").on("click", function (e) {
    e.preventDefault()
