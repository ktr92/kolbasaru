...
<?$APPLICATION->IncludeFile('/_include/cookie-message.php');?>
  ...
  <script type="text/javascript" src="<?=CUtil::GetAdditionalFileURL(STATIC_PATH.'/_js/fmmr.js');?>"  charset="utf-8"></script>

  <script type="text/javascript" src="<?=CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH.'/_js/main.js');?>"  charset="utf-8"></script>
